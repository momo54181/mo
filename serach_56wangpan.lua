...
script_info = {
	["title"] = "56网盘",
	["version"] = "0.0.1",
	["description"] = "https://www.56wangpan.com/",
}
...
function onSearch(key,page)
	local url = "https://www.56wangpan.com/search/o1kw"..pd.urlEncode(key).."pg"..page
	local result = {}
	local start = 1
	...
	while true do
		...
		href = "https://www.56wangpan.com"..href
...
function getUrl(href)
	...
	local p_start,p_end,fileID = string.find(href,"https://www.56wangpan.com/file/(%d+)")
	if fileID then
		url = "https://www.56wangpan.com/redirect/file?id="..fileID
